  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      ...
      <article className="mt-8">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">$$70B \times 2 \text{"{"} bytes{"}"} = 140 \text{"{"} GB of VRAM{"}"}$$</p>
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">$$70B \times 0.5 \text{"{"} bytes{"}"} \approx 35-40 \text{"{"} GB of VRAM{"}"}$$</p>
