  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      ...
      <article className="mt-8">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">$$Memory_{"{"}KV{"}"} = 2 \times Layer \times Head_{"{"}KV{"}"} \times Dim_{"{"}head{"}"} \times Precision \times Sequence\_Length$$</p>
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">$$Memory_{"{"}KV{"}"} = 2 \times 80 \times 8 \times 128 \times 2 \times 128,000 \approx 41.94 \text{"{"} GB{"}"}$$</p>
